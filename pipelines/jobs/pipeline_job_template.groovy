...
pipelineJob("${BUILD_FOLDER}/${JOB_NAME}") {
    ...
    parameters {
        ...
        stringParam('activeNodeTimeout', '10', 'Number of minutes we will wait for a label-matching node to become active.')
        ...
        booleanParam('keepReleaseLogs', false, 'If true, "Release" type pipeline Jenkins logs will be marked as "Keep this build forever".')
